...
4. FIM is a local linearized uncertainty approximation. It does not model retrieval failure, descriptor aliasing or all calibration/systematic errors; localizer front-end measurements remain mandatory.
...
8. The package does not ship localizer weights, map assets, or datasets. Adapters integrate an existing implementation.
